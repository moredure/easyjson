# easyjson [![Build Status](https://github.com/moredure/easyjson/actions/workflows/easyjson.yml/badge.svg)](https://github.com/moredure/easyjson/actions/workflows/easyjson.yml) [![Go Report Card](https://goreportcard.com/badge/github.com/moredure/easyjson)](https://goreportcard.com/report/github.com/moredure/easyjson)
...
```sh
# for Go < 1.17
go get -u github.com/moredure/easyjson/...
```
#### or
```sh
# for Go >= 1.17
go get github.com/moredure/easyjson && go install github.com/moredure/easyjson/...@latest
```
### Run:
```sh
...
Please see the [GoDoc](https://godoc.org/github.com/moredure/easyjson)
...
listing](https://godoc.org/github.com/moredure/easyjson) for the full listing of
...
Please see the [GoDoc listing](https://godoc.org/github.com/moredure/easyjson/buffer)
